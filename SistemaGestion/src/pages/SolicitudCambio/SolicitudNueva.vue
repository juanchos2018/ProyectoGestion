      ...
      <b-card>       
              <b-card-title>Datos Solicitud de Cambio</b-card-title>
                 ...
                 <br>
                  ...
                  <!--
                     <b-button type="button" :disabled="loading"  variant="primary"  @click="ObtenerNumeroSolicitud" class="p-2 px-4 btn-xs">
                            Catndiad
                  </b-button> -->
                  <br>
...
export default {
    ...
    methods: {       
                ...
                try {
                    ...
                    if (isPdf) {
                        ...
                        this.downloadUrl = url;
                            ...
                            let codigo="001";
                            const obj={codigo,id_proyecto,miembrojefeId,miembrosolicitanteId,fecha,objetivo,descripcion,respuesta,estado,documento,elemento};
        ...
        ObtenerNumeroSolicitud(){
            let me =this;
            var cantidad="1";
             axios.get('ApiWeb/SolicitudCambio.php/?cantidad='+cantidad).then(response => {                       
        ...
        GenerarPdf(){
           ...
           // doc.triangle(100, 100, 110, 100, 120, 130, 'FD');
            ...
            var numero =  me.numeroSolicitud+1;
